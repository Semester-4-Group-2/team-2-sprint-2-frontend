...
export default function Home() {
  ...
  <div className="latest-news">
    ...
    <div className="article">
      ...
      <p>Get ready to dive into the futuristic world of Night City with Cyberpunk 2077, the latest game from CD Projekt Red. Explore the massive open world, customize your character, and make choices that will shape the story.</p>
    </div>
    <div className="article">
      <img src="./images/test2.png" alt="News 2" />
      <h3>Upcoming DLC: Assassin's Creed Valhalla</h3>
      <p>Fans of Assassin's Creed Valhalla have a lot to look forward to with the upcoming Wrath of the Druids DLC. Set in Ireland, this new expansion promises new characters, new quests, and plenty of challenges.</p>
    </div>
    <div className="article">
      <img src="./images/test3.png" alt="News 3" />
      <h3>Multiplayer Update: Red Dead Redemption 2</h3>
      <p>It's been a long time coming, but Red Dead Redemption 2 players can finally enjoy the game's multiplayer mode. With a variety of activities to choose from, including co-op missions and player-vs-player modes.</p>
    </div>
